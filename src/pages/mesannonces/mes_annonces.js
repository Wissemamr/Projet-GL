...
import Cardfav from "../../components/course_cardA";
import { FiSearch } from "react-icons/fi";
import Navbarprin from "../../components/navbar/navbar";

const Mesannonce = (props) => {
    ...
    return ( 
        <div className="flex flex-col justify-center">
            ...
            <div className=" flex p-10 content-center pl-48">
                <p className="text-5xl font-publicSans font-semibold">Mes <span className="text-myGreenSecondary">Annonces</span></p>
            </div>
